...
import static com.example.pregapplication.R.*;
...
import com.example.pregapplication.DetailsActivity;
...
public class ItemAdapter extends RecyclerView.Adapter<ItemAdapter.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(@NonNull View itemView) {
            super(itemView);
            editTitle = itemView.findViewById(id.tittle1);
            editUrlImage = itemView.findViewById(id.image1);
            editauthor = itemView.findViewById(id.author);
            editdate = itemView.findViewById(id.date);
            mybutton = itemView.findViewById(id.details);
        }}}